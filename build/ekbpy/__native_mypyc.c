...
#include "__native_mypyc.h"
#include "__native_internal_mypyc.h"
...
PyObject *CPyInit_ekbpy___mypyc(void)
{
    PyObject* modname = NULL;
    if (CPyModule_ekbpy___mypyc_internal) {
        Py_INCREF(CPyModule_ekbpy___mypyc_internal);
        return CPyModule_ekbpy___mypyc_internal;
    }
    CPyModule_ekbpy___mypyc_internal = PyModule_Create(&module);
    if (unlikely(CPyModule_ekbpy___mypyc_internal == NULL))
        goto fail;
    modname = PyObject_GetAttrString((PyObject *)CPyModule_ekbpy___mypyc_internal, "__name__");
    CPyStatic_globals = PyModule_GetDict(CPyModule_ekbpy___mypyc_internal);
    ...
    return CPyModule_ekbpy___mypyc_internal;
    fail:
    Py_CLEAR(CPyModule_ekbpy___mypyc_internal);
    Py_CLEAR(modname);
    return NULL;
}
...
CPyL0: ;
    ...
    if (unlikely(cpy_r_r0 == NULL)) {
        CPy_AddTraceback("mypyc.py", "run_example", 5, CPyStatic_globals);
        goto CPyL11;
    }
CPyL1: ;
    ...
    if (unlikely(cpy_r_r3 == NULL)) {
        CPy_AddTraceback("mypyc.py", "run_example", 6, CPyStatic_globals);
        goto CPyL12;
    }
CPyL2: ;
...
CPyL6: ;
    ...
    if (unlikely(cpy_r_r9 == NULL)) {
        CPy_AddTraceback("mypyc.py", "run_example", 7, CPyStatic_globals);
        goto CPyL14;
    }
CPyL7: ;
...
PyObject *CPyPy_run_example(PyObject *self, PyObject *const *args, size_t nargs, PyObject *kwnames) {
    ...
    return retval;
fail: ;
    CPy_AddTraceback("mypyc.py", "run_example", 4, CPyStatic_globals);
    return NULL;
}
...
CPyL1: ;
    ...
    if (unlikely(cpy_r_r4 == NULL)) {
        CPy_AddTraceback("mypyc.py", "<module>", -1, CPyStatic_globals);
        goto CPyL17;
    }
CPyL2: ;
...
CPyL8: ;
    ...
    if (unlikely(cpy_r_r19 == NULL)) {
        CPy_AddTraceback("mypyc.py", "<module>", 11, CPyStatic_globals);
        goto CPyL17;
    }
CPyL9: ;
...
CPyL14: ;
    ...
    if (unlikely(cpy_r_r30 == NULL)) {
        CPy_AddTraceback("mypyc.py", "<module>", 12, CPyStatic_globals);
        goto CPyL17;
    }
CPyL15: ;
...
int CPyGlobalsInit(void)
{
    ...
    CPy_Init();
    CPyModule_ekbpy___mypyc = Py_None;
...
CPyModule *CPyModule_ekbpy___mypyc_internal = NULL;
CPyModule *CPyModule_ekbpy___mypyc;
...
static struct export_table_ekbpy___mypyc exports = {
    &CPyDef_run_example,
    &CPyDef___top_level__,
};

PyMODINIT_FUNC PyInit_mypyc__mypyc(void)
{
    static PyModuleDef def = { PyModuleDef_HEAD_INIT, "ekbpy.mypyc__mypyc", NULL, -1, NULL, NULL };
    int res;
    PyObject *capsule;
    PyObject *tmp;
    ...
    capsule = PyCapsule_New(&exports, "ekbpy.mypyc__mypyc.exports", NULL);
    if (!capsule) {
        goto fail;
    }
    ...
    extern PyObject *CPyInit_ekbpy___mypyc(void);
    capsule = PyCapsule_New((void *)CPyInit_ekbpy___mypyc, "ekbpy.mypyc__mypyc.init_ekbpy___mypyc", NULL);
    if (!capsule) {
        goto fail;
    }
    res = PyObject_SetAttrString(module, "init_ekbpy___mypyc", capsule);
    Py_DECREF(capsule);
    if (res < 0) {
        goto fail;
    }
