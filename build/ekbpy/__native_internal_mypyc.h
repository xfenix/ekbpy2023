#ifndef MYPYC_NATIVE_INTERNAL_ekbpy___mypyc_H
#define MYPYC_NATIVE_INTERNAL_ekbpy___mypyc_H
#include <Python.h>
#include <CPy.h>
...
extern CPyModule *CPyModule_ekbpy___mypyc_internal;
extern CPyModule *CPyModule_ekbpy___mypyc;
