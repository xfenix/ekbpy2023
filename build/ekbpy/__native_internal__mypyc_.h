#ifndef MYPYC_NATIVE_INTERNAL_ekbpy____mypyc__H
#define MYPYC_NATIVE_INTERNAL_ekbpy____mypyc__H
#include <Python.h>
#include <CPy.h>
...
extern CPyModule *CPyModule_ekbpy____mypyc__internal;
extern CPyModule *CPyModule_ekbpy____mypyc_;
