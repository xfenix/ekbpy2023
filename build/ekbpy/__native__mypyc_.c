...
#include "__native__mypyc_.h"
#include "__native_internal__mypyc_.h"
...
PyObject *CPyInit_ekbpy____mypyc_(void)
{
    PyObject* modname = NULL;
    if (CPyModule_ekbpy____mypyc__internal) {
        Py_INCREF(CPyModule_ekbpy____mypyc__internal);
        return CPyModule_ekbpy____mypyc__internal;
    }
    CPyModule_ekbpy____mypyc__internal = PyModule_Create(&module);
    if (unlikely(CPyModule_ekbpy____mypyc__internal == NULL))
        goto fail;
    modname = PyObject_GetAttrString((PyObject *)CPyModule_ekbpy____mypyc__internal, "__name__");
    CPyStatic_globals = PyModule_GetDict(CPyModule_ekbpy____mypyc__internal);
    ...
    return CPyModule_ekbpy____mypyc__internal;
    fail:
    Py_CLEAR(CPyModule_ekbpy____mypyc__internal);
    Py_CLEAR(modname);
    return NULL;
}
...
CPyL0: ;
    ...
    if (unlikely(cpy_r_r0 == NULL)) {
        CPy_AddTraceback("_mypyc_.py", "run_example", 5, CPyStatic_globals);
        goto CPyL11;
    }
CPyL1: ;
    ...
    if (unlikely(cpy_r_r3 == NULL)) {
        CPy_AddTraceback("_mypyc_.py", "run_example", 6, CPyStatic_globals);
        goto CPyL12;
    }
CPyL2: ;
...
CPyL6: ;
    ...
    if (unlikely(cpy_r_r9 == NULL)) {
        CPy_AddTraceback("_mypyc_.py", "run_example", 7, CPyStatic_globals);
        goto CPyL14;
    }
CPyL7: ;
...
PyObject *CPyPy_run_example(PyObject *self, PyObject *const *args, size_t nargs, PyObject *kwnames) {
    ...
    return retval;
fail: ;
    CPy_AddTraceback("_mypyc_.py", "run_example", 4, CPyStatic_globals);
    return NULL;
}
...
CPyL1: ;
    ...
    if (unlikely(cpy_r_r4 == NULL)) {
        CPy_AddTraceback("_mypyc_.py", "<module>", -1, CPyStatic_globals);
        goto CPyL17;
    }
CPyL2: ;
...
CPyL8: ;
    ...
    if (unlikely(cpy_r_r19 == NULL)) {
        CPy_AddTraceback("_mypyc_.py", "<module>", 11, CPyStatic_globals);
        goto CPyL17;
    }
CPyL9: ;
...
CPyL14: ;
    ...
    if (unlikely(cpy_r_r30 == NULL)) {
        CPy_AddTraceback("_mypyc_.py", "<module>", 12, CPyStatic_globals);
        goto CPyL17;
    }
CPyL15: ;
...
int CPyGlobalsInit(void)
{
    ...
    CPy_Init();
    CPyModule_ekbpy____mypyc_ = Py_None;
...
CPyModule *CPyModule_ekbpy____mypyc__internal = NULL;
CPyModule *CPyModule_ekbpy____mypyc_;
...
static struct export_table_ekbpy____mypyc_ exports = {
    &CPyDef_run_example,
    &CPyDef___top_level__,
};

PyMODINIT_FUNC PyInit__mypyc___mypyc(void)
{
    static PyModuleDef def = { PyModuleDef_HEAD_INIT, "ekbpy._mypyc___mypyc", NULL, -1, NULL, NULL };
    int res;
    PyObject *capsule;
    PyObject *tmp;
    ...
    capsule = PyCapsule_New(&exports, "ekbpy._mypyc___mypyc.exports", NULL);
    if (!capsule) {
        goto fail;
    }
    ...
    extern PyObject *CPyInit_ekbpy____mypyc_(void);
    capsule = PyCapsule_New((void *)CPyInit_ekbpy____mypyc_, "ekbpy._mypyc___mypyc.init_ekbpy____mypyc_", NULL);
    if (!capsule) {
        goto fail;
    }
    res = PyObject_SetAttrString(module, "init_ekbpy____mypyc_", capsule);
    Py_DECREF(capsule);
    if (res < 0) {
        goto fail;
    }
