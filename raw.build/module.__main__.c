 ...
 * created by Nuitka version 1.4.1
 *
...
static PyCodeObject *codeobj_8596b928ccd8edeac75a2b746948f6ef;
/* For use in "MainProgram.c". */
PyCodeObject *codeobj_main = NULL;

static void createModuleCodeObjects(void) {
    module_filename_obj = mod_consts[1]; CHECK_OBJECT(module_filename_obj);
    codeobj_8596b928ccd8edeac75a2b746948f6ef = MAKE_CODE_OBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[10], mod_consts[10], NULL, NULL, 0, 0, 0);
    codeobj_main = codeobj_8596b928ccd8edeac75a2b746948f6ef;
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_8596b928ccd8edeac75a2b746948f6ef;
    ...
    // Module code.
    frame_8596b928ccd8edeac75a2b746948f6ef = MAKE_MODULE_FRAME(codeobj_8596b928ccd8edeac75a2b746948f6ef, module___main__);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_8596b928ccd8edeac75a2b746948f6ef);
    assert(Py_REFCNT(frame_8596b928ccd8edeac75a2b746948f6ef) == 2);

    // Framed code:
    {
        PyObject *tmp_imported_value_1;
        frame_8596b928ccd8edeac75a2b746948f6ef->m_frame.f_lineno = 1;
    ...
    tmp_import_from_1__module = NULL;
    {
        ...
        frame_8596b928ccd8edeac75a2b746948f6ef->m_frame.f_lineno = 4;
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_8596b928ccd8edeac75a2b746948f6ef, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_8596b928ccd8edeac75a2b746948f6ef->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_8596b928ccd8edeac75a2b746948f6ef, exception_lineno);
    }



    assertFrameObject(frame_8596b928ccd8edeac75a2b746948f6ef);
